 ...
 *
 * Score Distribution:
 * - Score 1: Common letters (high frequency) - 8 Russian letters
 * - Score 2: Medium frequency letters - 16 letters (8 Russian + 8 Latin)
 * - Score 3: Less common letters - 16 letters (8 Russian + Latin Q,W,X,Y,Z)
 * - Score 4: Rare letters - 9 Russian letters
 */
