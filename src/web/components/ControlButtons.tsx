...
export function ControlButtons({
  ...
  return (
    <div className="flex items-center gap-[var(--spacing-resp-sm)] flex-1 justify-center min-w-0">
      {/* Status message or submit button */}
      ...
      <button
        ...
        className={cn(
          'px-[var(--spacing-resp-md)] py-[var(--spacing-resp-xs)] font-bold text-[var(--text-resp-sm)] transition-all duration-200 hover:shadow-depth-2 hover:scale-105 flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed relative flex-shrink-0',
          showSuggestions
