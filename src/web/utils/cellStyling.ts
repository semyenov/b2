...
export function getCellClassName({
  ...
  return cn(
    ...
    'aspect-square w-full border flex items-center justify-center text-[length:var(--text-resp-board)] font-black transition-all duration-200 relative leading-none',
